...
export default function Blog({
  ...
  return (
    <div
      ...
      className={`relative col-span-1 h-96 overflow-hidden border border-black bg-slate hover:bg-gradient-to-bl from-slate-100/25 to-slate-300/25 hover:shadow-lg hover:border-gray-500 ${
        large ? "md:col-span-2" : ""
      }`}
    >
