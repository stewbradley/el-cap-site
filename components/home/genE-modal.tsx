...
const GenEModal = ({
    ...
    return (
      <Modal showModal={showGenEModal} setShowModal={setShowGenEModal}>
        ...
        <div className="w-full overflow-hidden md:max-w-md md:border md:border-gray-500 md:shadow-xl border border-black bg-gradient-to-bl from-slate-100/70 via-slate to-slate-200/70 hover:shadow-lg hover:border-amber-500 mx-auto my-auto">
