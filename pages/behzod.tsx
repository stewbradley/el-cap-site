      ...
      >
        ...
        >
          <Balancer>
            ...
            <br></br>  
            <p>If there was a book, movie, podcast, or blog post that you could make everyone you work with consume, what would it be and why? I encourage almost everyone I meet to read The School of Life's An Emotional Education. I think that we often expect too much of each other and not enough of ourselves, and coming to grips with how we can better identify and engage with our own thoughts and emotions is the first step to being the best versions of ourselves.</p>
            <br></br>  
            ...
            <br></br>  
            <p>Favorite music to work to? Almost anything written by The American Dollar or In Love With A Ghost's "Let's Go" EP.</p>
          </Balancer>
        </motion.p> 
      </motion.div>
    </ContributorLayout>
